...
namespace EtAlii.xMvvm
{
    ...
    public partial class CompositionView : EtAlii.xMvvm.XamlVariant1.View<CompositionViewModel>  
    {
        ...
        public CompositionView(GameObject gameObject) : base(gameObject)
        {
            ...
            _subject = ﻿new EtAlii.xMvvm.XamlVariant1.ElementBinding<CompositionViewModel>(this, "Subject", vm => vm.SubjectTransformation);
            _canvas = ﻿new EtAlii.xMvvm.XamlVariant1.ElementBinding<CompositionViewModel>(this, "Canvas", vm => vm.CanvasTransformation);
